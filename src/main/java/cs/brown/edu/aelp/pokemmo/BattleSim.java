...
public final class BattleSim {
  ...
  public static void main(String[] args) {
     ...
     * 
     * MoveLoader.addOverride(new Wish()); Move wish =
     * MoveLoader.getMoveById(273);
     * 
     * Arena arena = new Arena();
     * 
     * System.out.println(p1.getMaxHp()); System.out.println(p2.getMaxHp());
     * System.out.println(p3.getMaxHp());
     * 
     * Trainer t1 = new Trainer(1); t1.addPokemonToTeam(p1);
     * 
     * Trainer t2 = new Trainer(2); t2.addPokemonToTeam(p2);
     * t2.addPokemonToTeam(p3);
     * 
     * PvPBattle battle = new PvPBattle(-1, arena, t1, t2);
     * 
     * battle.setTurn(new NullTurn(t1)); battle.setTurn(new NullTurn(t2));
     * battle.evaluate();
     * 
     * System.out.println(p1); System.out.println(p2);
     * 
     * battle.setTurn(new FightTurn(t1, atk)); battle.setTurn(new FightTurn(t2,
     * wish)); battle.evaluate();
     * 
     * System.out.println(p1); System.out.println(p2);
     * 
     * battle.setTurn(new NullTurn(t1)); battle.setTurn(new NullTurn(t2));
